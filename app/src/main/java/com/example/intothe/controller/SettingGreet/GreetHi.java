...
import com.example.intothe.databinding.GreetHiBinding;

import java.util.Random;

public class GreetHi extends AppCompatActivity {

    private GreetHiBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = GreetHiBinding.inflate(getLayoutInflater());
        ...
        ReportDBHelper myDb2 = new ReportDBHelper(GreetHi.this);
